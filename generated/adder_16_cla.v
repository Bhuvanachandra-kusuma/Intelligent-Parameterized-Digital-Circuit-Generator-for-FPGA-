...
module adder_16_cla(
    ...
    cla_4bit b0(A[3:0],   B[3:0],   C[0], SUM[3:0],   dummy, P_group[0], G_group[0]);
    cla_4bit b1(A[7:4],   B[7:4],   C[1], SUM[7:4],   dummy, P_group[1], G_group[1]);
    cla_4bit b2(A[11:8],  B[11:8],  C[2], SUM[11:8],  dummy, P_group[2], G_group[2]);
    cla_4bit b3(A[15:12], B[15:12], C[3], SUM[15:12], dummy, P_group[3], G_group[3]);
